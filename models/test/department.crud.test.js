...
describe('Department', () => {
  ...
  describe('Reading data', () => {
    ...
    it('should return all the data with "find" method', async () => {
      ...
      const expectedLength12 = 2;
      expect(departments.length).to.be.equal(expectedLength12);
    });
  ...
  describe('Updating data', () => {
    ...
    it('should properly update multiple documents with "updateMany" method', async () => {
      ...
      const departments = await Department.find();
      expect(departments[0].name).to.equal('Updated!');
      expect(departments[1].name).to.equal('Updated!');
    });
  ...
  describe('Removing data', () => {
    ...
    it('should properly remove one document with "deleteOne" method', async () => {
      ...
      const updatedDepartment = await Department.find();
      expect(updatedDepartment.length).to.equal(1);
    });
    ...
    it('should properly remove one document with "remove" method', async () => {
      ...
      expect(removedDepartment).to.equal(null);
    });
  
    it('should properly remove multiple documents with "deleteMany" method', async () => {
      await Department.deleteMany({});
      const updatedDepartment = await Department.find();
      expect(updatedDepartment.length).to.equal(0);
    });
